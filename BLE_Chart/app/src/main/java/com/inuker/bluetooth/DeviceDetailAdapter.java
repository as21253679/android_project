...
public class DeviceDetailAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(result.uuid.toString().toUpperCase().equals("6E400003-B5A3-F393-E0A9-E50E24DCCA9E")) {
            holder.uuid.setText(String.format("click here!"));
            holder.uuid.getPaint().setFakeBoldText(true);
            holder.uuid.setTextSize(TypedValue.COMPLEX_UNIT_SP, 48.0f);
        }
        else
